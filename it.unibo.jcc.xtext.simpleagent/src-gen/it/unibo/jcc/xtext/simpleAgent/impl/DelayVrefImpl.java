 ...
 * </p>
 * <ul>
 *   <li>{@link it.unibo.jcc.xtext.simpleAgent.impl.DelayVrefImpl#getReftime <em>Reftime</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DelayVrefImpl extends DelayImpl implements DelayVref
{
  ...
  {
    return SimpleAgentPackage.Literals.DELAY_VREF;
  }
  ...
  public NotificationChain basicSetReftime(VarRef newReftime, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimpleAgentPackage.DELAY_VREF__REFTIME, oldReftime, newReftime);
  ...
  public void setReftime(VarRef newReftime)
  {
    if (newReftime != reftime)
    {
      ...
      if (reftime != null)
        msgs = ((InternalEObject)reftime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimpleAgentPackage.DELAY_VREF__REFTIME, null, msgs);
      if (newReftime != null)
        msgs = ((InternalEObject)newReftime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimpleAgentPackage.DELAY_VREF__REFTIME, null, msgs);
      msgs = basicSetReftime(newReftime, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimpleAgentPackage.DELAY_VREF__REFTIME, newReftime, newReftime));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SimpleAgentPackage.DELAY_VREF__REFTIME:
