 ...
 * </p>
 * <ul>
 *   <li>{@link it.unibo.jcc.xtext.simpleAgent.impl.PStructRefImpl#getStruct <em>Struct</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PStructRefImpl extends PHeadImpl implements PStructRef
{
  ...
  {
    return SimpleAgentPackage.Literals.PSTRUCT_REF;
  }
  ...
  public NotificationChain basicSetStruct(PStruct newStruct, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimpleAgentPackage.PSTRUCT_REF__STRUCT, oldStruct, newStruct);
  ...
  public void setStruct(PStruct newStruct)
  {
    if (newStruct != struct)
    {
      ...
      if (struct != null)
        msgs = ((InternalEObject)struct).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimpleAgentPackage.PSTRUCT_REF__STRUCT, null, msgs);
      if (newStruct != null)
        msgs = ((InternalEObject)newStruct).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimpleAgentPackage.PSTRUCT_REF__STRUCT, null, msgs);
      msgs = basicSetStruct(newStruct, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimpleAgentPackage.PSTRUCT_REF__STRUCT, newStruct, newStruct));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SimpleAgentPackage.PSTRUCT_REF__STRUCT:
